...
#########################################################################
#This version in use by CoderDojo Dun Laoghaire (@CoderDojoDL) 			#
#The game uses a Sensehat Pi Shield to display images onto a 8x8 LED 	#
#Its a one player games playing against the computer					#
#It uses Up Arrow to make a choice - this scrolls through the images	#
# 0 - rock																#	
# 1 - Spock																#
# 2 - paper																#
# 3 - lizard															#
# 4 - scissors															#
#Then the computer makes a random choice and the result is displayed  	#
#The output goes to the LED and to the console							#
#Then you play again by pressing Up Arrow or Down Arrow to quit			#
#########################################################################

###import gaming functions for displaying the game###
import pygame
from pygame.locals import *

###import the library for the SenseHat###
...
###create some global variables to remember each players choices###
    ...
    while running == True:
        ...
        for event in pygame.event.get():
            ...
            if event.type == KEYDOWN:
                '''Looks for Return key for confirmation'''
...
###START THE GAME##
sense.show_message("Hi!", text_colour=[155, 100, 30], scroll_speed = 0.08)
sense.show_message("Press 'Up' to scroll and Enter to make your choice", text_colour=[155, 255, 255], scroll_speed = 0.05)
sense.load_image("0.png")

###Loop around and play each time###
###Give the player a choice after each game###
